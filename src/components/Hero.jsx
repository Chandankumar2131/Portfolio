...
export default function Hero() {
  const focusAreas = [
    { name: "MERN", accent: "from-cyan-400/18 to-blue-400/10" },
    { name: "DSA", accent: "from-purple-400/18 to-violet-500/10" },
    { name: "System Design", accent: "from-blue-400/18 to-sky-500/10" },
    { name: "REST APIs", accent: "from-orange-300/16 to-cyan-400/10" },
    { name: "Cloud Deployment", accent: "from-emerald-400/18 to-green-400/10" },
  ];
      ...
      <div className="relative z-10 mx-auto grid min-h-[calc(100vh-9rem)] w-full max-w-7xl grid-cols-1 items-center gap-12 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="text-center lg:text-left">
          ...
          <p className="mx-auto mt-6 max-w-3xl text-base leading-8 text-slate-400 md:text-lg lg:mx-0">
            ...
            applications with scalable React interfaces, secure REST APIs,
          ...
          <div className="relative w-full max-w-[390px]">
            ...
            <div className="group relative overflow-hidden rounded-[2.25rem] border border-cyan-300/15 bg-gradient-to-br from-white/[0.06] via-cyan-950/20 to-slate-950/85 p-6 text-center shadow-2xl backdrop-blur-xl transition duration-500 hover:-translate-y-2 hover:border-cyan-300/35 hover:shadow-[0_0_42px_rgba(34,211,238,0.08)]">
              ...
              <div className="absolute left-6 right-6 top-6 flex items-center justify-between">
                <span className="rounded-full border border-cyan-300/25 bg-cyan-300/10 px-4 py-1.5 text-xs font-semibold uppercase tracking-[0.18em] text-cyan-100">
                  Available
                </span>

                <span className="h-3.5 w-3.5 rounded-full bg-cyan-300/80 shadow-[0_0_12px_rgba(103,232,249,0.55)]" />
              </div>

              <div className="relative mx-auto mt-16 flex h-44 w-44 items-center justify-center rounded-full border border-cyan-300/15 bg-slate-950/65 shadow-[inset_0_1px_0_rgba(255,255,255,0.06)] transition duration-500 group-hover:scale-105">
              ...
              <div className="relative mt-8">
                ...
                <p className="mt-3 text-xs font-bold uppercase tracking-[0.3em] text-cyan-300">
              ...
              <div className="relative mt-6 h-px w-full bg-gradient-to-r from-transparent via-cyan-400/30 to-transparent" />
            </div>
          </div>
        </div>
      </div>
